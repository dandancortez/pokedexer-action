                ...
                AnimatedContent(
                    ...
                    if (
                        ...
                        HomeMenu(
                            ...
                            onPokemonSelected = {
                                onSearchResultSelected(SearchResult.PokemonEvent(it))
                            },
                        )
                    }
                }
...
private fun HomeMenu(
    ...
    Column(
        ...
        pokemonOfTheDay?.let { pokemon ->
            Text(
                text = stringResource(R.string.pokemonOfTheDayLabel),
